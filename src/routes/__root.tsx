...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI-powered mock interview simulator for engineering placements." },
      { name: "author", content: "PlacementPrep" },
      { property: "og:title", content: "PlacementPrep AI" },
